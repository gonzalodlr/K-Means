...
public class ContinuousItem extends Item {
	...
	/**
	 * This is a constructor for the 'ContinuousItem' class.
	 * Creates a new 'Item' object with the specified attribute and value.
	 * 
	...
	/**
	 * This Java function determines the distance (in absolute value)
	 * between the scaled value stored in the current item (this.getValue())
	 * and the scaled value associated with the parameter a. To obtain scaled values
	 * make use of getScaledValue(...)
	 * 
	 * @param a is an object that is being passed into the method.
	 *          It is used to calculate the distance between the current object and
	 *          the object passed in. The method checks if the object passed in is
	 *          an instance of the ContinuousItem class and if so, it calculates the
	 *          distance between the two attribute values.
